...
1. `connect` creates a thirty-minute relay session with `POST https://api2.onairos.uk/mcp/hermes/session`.
...
| `expired` | The thirty-minute relay no longer exists | Start a fresh connection |
